...
# Ralph Execute Loop Script for Gemini CLI
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --log-file)
            ...
            ;;
        --help)
            echo "Ralph Execute Loop for Gemini CLI - Run the autonomous execution phase"
            echo ""
...
# Display banner
echo -e "${BLUE}╔════════════════════════════════════════════════╗${NC}"
echo -e "${BLUE}║     Ralph Wiggum Execution Loop - Gemini      ║${NC}"
echo -e "${BLUE}╚════════════════════════════════════════════════╝${NC}"
echo ""
